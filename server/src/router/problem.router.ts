...
import { createProblem,getProblem,getAllProblem,solvedProblem} from "../controllers/problem.controller.ts";
...
// ProblemRouter.patch('/:id',auth_middleware,required_role(Role.ADMIN),updateProbelm);
